            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  <h4 className="title">Giá cả hợp lý</h4>
                  <p className="disc">
                    Chúng tôi cung cấp những món ăn với giá tốt nhất dành cho
                    bạn.
                  </p>
                </div>
              </div>
              ...
              <div className="single-short-service-area-start">
                <div className="icon-area">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M33 26H30V56H33V26ZM35 26V56H38V26H35ZM42 26C45.3137 26 48 28.6863 48 32V56H45V32C45 30.3431 43.6569 29 42 29C40.3431 29 39 30.3431 39 32V56H39V32C39 28.6863 41.6863 26 42 26Z"
                      fill="#629D23"
                    />
                  </svg>
                </div>
                <div className="information">
                  <h4 className="title">Thực đơn phong phú</h4>
                  <p className="disc">
                    Các món ăn đa dạng giúp bạn có thể dễ dàng chọn lựa.
                  </p>
                </div>
              </div>
              {/* single service area end */}
              ...
              <div className="single-short-service-area-start">
                <div className="icon-area">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M43.6986 45.955L47.8708 34.045H45.7341L41.5618 45.955H43.6986Z"
                      fill="#629D23"
                    />
                    <path
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    Chúng tôi hỗ trợ bạn bất cứ khi nào bạn cần.
                  </p>
                </div>
              </div>
              {/* single service area end */}
              ...
              <div className="single-short-service-area-start">
                <div className="icon-area">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M32.5466 52.0632L45.2407 36.599L47.1911 38.249L34.4969 53.7132L32.5466 52.0632Z"
                      fill="#629D23"
                    />
                  </svg>
                </div>
                <div className="information">
                  <h4 className="title">Chương trình khuyến mại</h4>
                  <p className="disc">
                    Các chương trình khuyến mại diễn ra thường xuyên với nhiều
                    ưu đãi lớn.
                  </p>
                </div>
              </div>
