            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="vendor-search-area-wrapper">
                      <h1 className="title">DANH SÁCH ĐỐI TÁC</h1>
                      <form
                        ...
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                          ...
                          <li className="nav-item" role="presentation">
                            <button
                              ...
                              className={`single-button nav-link ${
                      ...
                      <div className="row g-4">
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/01.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                            ...
                            <div className="location">
                              ...
                              <p>
                                530 Post Ct El Dorado Hills California ,United
                                States
                              </p>
                            </div>
                            <div className="location">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/02.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/03.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/04.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/05.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/06.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/07.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                          <div className="single-vendor-area">
                            <div className="logo-vendor">
                              <img
                                src="assets/images/vendor/08.svg"
                                alt="vendor"
                              />
                            </div>
                            <h3 className="title">
