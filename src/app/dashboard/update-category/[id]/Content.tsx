...
export default function EditCategoryPage() {
    ...
    const loadCategoryData = async () => {
        try {
            ...
            const response = await AdminCategoryService.getAdminCategoryById(categoryId);
            ...
            toast.error('Không thể tải thông tin danh mục. Vui lòng thử lại.');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setIsLoading(true);
            await AdminCategoryService.updateAdminCategory(categoryId, updateData);
                    ...
                    <div className="col-lg-8">
                        <div className="card shadow-lg border-0">
                            <div className="card-body text-center py-5">
                                ...
                                <p className="mt-3 text-muted">Đang tải thông tin danh mục...</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card shadow-lg border-0">
                        ...
                        <div className="card-header text-white" style={{ background: 'linear-gradient(135deg, #2d5a3d, #4a7c59)' }}>
                            <div className="d-flex align-items-center" style={{ padding: '20px' }}>
                                <i className="fas fa-edit me-3 fs-4"></i>
                                <div>
                                    <h3 className="mb-0" style={{ color: 'white' }}>Chỉnh Sửa Danh Mục</h3>
                                    <p className="mb-0 opacity-75" style={{ color: 'white' }}>Cập nhật thông tin danh mục sản phẩm</p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="row g-3">
                                                    <div className="col-md-6">
                                                        ...
                                                        />
                                                        <div className="form-text">
                                                            Chọn file để thay đổi hình ảnh hiện tại
                                                        </div>
                                                        {imagePreview && (
                                                            <div className="mt-2">
                                                    ...
                                                    <div className="col-md-6">
                                                        <label className="form-label fw-bold">Icon danh mục</label>
                                                        <input
                                                            type="file"
                                                            name="iconFile"
                                                            className="form-control"
                                                        ...
                                                        />
                                                        <div className="form-text">
                                                            Chọn file để thay đổi icon hiện tại
                                                        </div>
                                                        {iconPreview && (
                                                            <div className="mt-2">
